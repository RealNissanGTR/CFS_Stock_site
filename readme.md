...
### Option A (easiest): Optional auto-install setup

This script can install Python for the user (optional), create the virtual environment, and install all dependencies.
